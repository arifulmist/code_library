...
int main()
{
    ...
    while (t--)
    {
     ...
     // cout<<cnts<<cntd<<cntch<<nl;
   if(cnts>=2 && cntch>=4&& cntd>=4)
   {
    p("The last character can be any type.");
   }
   else if(cnts<2 &&cntch>=4&& cntd>=4)
   {
    p("The last character must be a symbol.");
   }
   else if(cntch<4&&cnts>=2 &&cntd>=4)
   {
    p("The last character must be a letter.");
   }
   else 
   {
     p("The last character must be a digit.");
   }    
}
